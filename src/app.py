...
activities = {
    ...
    "Soccer Training": {
        "description": "Improve your soccer skills with drills and scrimmages",
    ...
    "Art Workshop": {
        "description": "Explore painting and drawing in a creative studio setting",
        "schedule": "Mondays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
        "participants": ["ava@mergington.edu", "mia@mergington.edu"]
    },
    "Drama Club": {
        "description": "Practice acting, stagecraft, and perform scenes",
        "schedule": "Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 20,
        "participants": ["noah@mergington.edu", "chloe@mergington.edu"]
    },
    "Science Olympiad": {
        "description": "Prepare for science competitions and tackle hands-on challenges",
        "schedule": "Wednesdays, 4:00 PM - 5:30 PM",
        "max_participants": 16,
        "participants": ["oliver@mergington.edu", "grace@mergington.edu"]
    },
    "Math Club": {
        "description": "Solve puzzles, learn new problem-solving techniques, and compete in math events",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 18,
